...
export default function ChangeItem({ changes: change }: ChangeItemProps) {
  if (Array.isArray(change)) {
    ...
    const did_anticheats_change =
      JSON.stringify(old_game.anticheats) != JSON.stringify(new_game.anticheats);
              ...
              {did_anticheats_change && (
                <Group>
                  ...
                  {old_game.anticheats.map(anticheat => {
                    return (
                      <Tooltip withArrow label={anticheat} key={anticheat}>
